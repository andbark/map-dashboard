        ...
        <div className="mb-4">
          ...
          <div className="mt-1 flex rounded-md shadow-sm">
            <input
              ...
              className="flex-1 min-w-0 block w-full px-3 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
